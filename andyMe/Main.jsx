...
const Main = () => {
    ...
    <Switch style={estilasos.unSwitch}  trackColor={{ false: "#767577", true: "#81b0ff" }}
        thumbColor={isEnabled ? "#f5dd4b" : "#f4f3f4"}
        onValueChange={toggleSwitch}
        value={isEnabled}/>
        <Text style={estilasos.switchTexto}>Colores</Text>
    <Text style={estilasos.testo}>¡Qué tal!</Text>
    <Text style={estilasos.midddleText}>Bienvenido a mi primera aplicación, en la que me gustaría que me conocieras. 
    Esto va a ser a través de 5 puntos en los que hablaré un poco de mí. Comencemos:</Text>
    <Text></Text>
    <Text></Text>
